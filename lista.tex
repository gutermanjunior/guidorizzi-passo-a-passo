...
% Este comando força a "Lista de Exercícios" a aparecer no Sumário
\addcontentsline{toc}{chapter}{Lista de Exercícios Sugeridos}

\begin{resumocapitulo}
Esta lista compila todos os exercícios selecionados dos livros-texto base (\textit{Guidorizzi}). 
...
\begin{itemize}[label=$\square$, leftmargin=*, itemsep=0.8em]
    ...
    3d, 3e, 3n, 5b, 5e, 6b, 6n, 7b, 7f, 8, 9, 10e, 10h, 11a, 11f, 11j, 12, 13b, 13f, 13j, 15, 16, 17a, 17c, 18, 19a, 19d, 20c, 22, 23b, 23d, 23f
    
    \item \textbf{Seção 1.3} (Módulo): 1f, 2d, 2f, 3c, 3m, 3n, 5b, 7c
    \item \textbf{Seção 1.4} (Intervalos): 1a, 1c, 3, 4b, 4d
    \item \textbf{Seção 1.6} (Supremo e Ínfimo): 2, 3b, 8, 10
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[label=$\square$, leftmargin=*, itemsep=0.8em]
    ...
    \item \textbf{Seção 2.2}: 1c, 1f, 1i, 2b \item \textbf{Seção 2.3}: 1b, 2 \item \textbf{Seção 2.4}: 1a, 1c, 2a, 2f, 2g, 3b, 3e, 4b, 4e, 4f
\end{itemize}
\end{tcolorbox}
